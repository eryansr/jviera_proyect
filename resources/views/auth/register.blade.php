                ...
                <div class="col-lg-5 col-md-5 ml-auto">
                    <div class="info-area info-horizontal mt-5">
                        ...
                        <div class="description">
                            <h5 class="info-title">{{ __('Fartodo') }}</h5>
                            <p class="description">
                                {{ __('Estamos dedicados al bienestar de nuestros clientes.') }}
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        <div class="icon nc-hat-3">
                            <i class="nc-icon nc-hat-3"></i>
                        </div>
                        <div class="description">
                            <h5 class="info-title">{{ __('Equipo') }}</h5>
                            <p class="description">
                                {{ __('Contamos con personal altamete calificado.') }}
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        <div class="icon nc-money-coins">
                            <i class="nc-icon nc-atom"></i>
                        </div>
                        <div class="description">
                            <h5 class="info-title">{{ __('Precios') }}</h5>
                            <p class="description">
                                {{ __('Buscamos la amplia variedad de productos a los mejores precios.') }}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-signup text-center">
                        <div class="card-header ">
                            ...
                            <div class="social">
                                ...
                                <p class="card-description">{{ __('Redes') }}</p>
                            </div>
                        </div>
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="card-footer ">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('¡Empecemos!') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
