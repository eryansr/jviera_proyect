                    ...
                    <div class="card-body ">
                        <form class="form" method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="card-header ">
                                <h3 class="header text-center">{{ __('Restablecer la contraseña') }}</h3>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-warning btn-round mb-3">{{ __('Restablecer la contraseña') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
